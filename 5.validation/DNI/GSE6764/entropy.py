...
# 计算每个基因的度
csv_file = 'stage8.csv'  # 你的CSV文件路径
gene_degrees, total_degree = calculate_degree(csv_file)

# 你提供的子集
#gene_subset = ['FOS', 'ELK1', 'ACTL6B', 'PIK3R1', 'TPMT', 'MZT1', 'ARID2', 'ANXA3', 'FAF1','E2F5', 'SMARCA4', 'E2F2', 'MYC', 'GRB2',  'ARID1B', 'SMARCA2', 'SHC3', 'GAB1','FOSB', 'NFYA', 'TCF3', 'BRCA1', 'GMPS', 'PTGS2', 'CTNNB1', 'MET', 'E2F4','TP53', 'SMAD3', 'ATF2', 'PLCG1',  'IMPDH2', 'ATF5']
...
def calculate_y(a, b, c, d):
    ...
    return -((d/10762) * math.log2(a/10762))
