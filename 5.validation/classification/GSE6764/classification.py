...
file_names = ['class_count1.csv', 'class_count2.csv', 'class_count3.csv', 'class_count4.csv', 'class_count5.csv',
              'class_count6.csv', 'class_count7.csv']

# Colors for each plot
colors = ['#DEECF6', '#AFC8E2', '#E2F2CD', '#B6DAA7', '#E8E0EF',  '#C2B1D7', '#F9D5D5']
...
for i, file_name in enumerate(file_names):
    ...
    fpr, tpr, _ = roc_curve(y_test, y_prob[:, 1], pos_label=1, drop_intermediate=False)  # Use all thresholds
    roc_auc = auc(fpr, tpr)
